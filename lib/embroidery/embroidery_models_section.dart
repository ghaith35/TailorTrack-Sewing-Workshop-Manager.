              ...
              child: Column(children: [
                ...
                DropdownButtonFormField<int?>(
                  ...
                  decoration: const InputDecoration(
                      labelText: 'العميل', filled: true, fillColor: Colors.white),
                  items: [
                ...
                DropdownButtonFormField<int?>(
                  ...
                  decoration: const InputDecoration(
                      labelText: 'الموسم', filled: true, fillColor: Colors.white),
                  items: [
                    const DropdownMenuItem(value: null, child: Text('الكل')),
                      ...
                      itemBuilder: (_, i) {
                        ...
                        return Card(
                          ...
                          child: ListTile(
                            ...
                            onTap: () =>
                                setState(() => _selectedModelId = m['id'] as int),
                            trailing: Row(
                              ...
                              showDialog(
                                ...
                                builder: (_) => Dialog(
                                  ...
                                  child: InteractiveViewer(
                                    child: Image.network(
                                      '${globalServerUri.toString()}${selected['image_url']}',
                                      fit: BoxFit.contain,
              ...
              child: SingleChildScrollView(
                child: Column(
                  ...
                  children: [
                    ...
                    DropdownButtonFormField<int?>(
                      decoration:
                          const InputDecoration(labelText: 'الموسم'),
                      value: seasonId,
                      items: [
                        const DropdownMenuItem(
                            value: null, child: Text('بدون موسم')),
                        ..._seasons.map((s) => DropdownMenuItem<int?>(
                              value: s['id'] as int,
                    ...
                    TextFormField(
                      ...
                      decoration:
                          const InputDecoration(labelText: 'سعر الغرزة'),
                      keyboardType:
                    ...
                    TextFormField(
                      ...
                      decoration:
                          const InputDecoration(labelText: 'عدد الغرز'),
            ...
            ElevatedButton(
              onPressed: () async {
                ...
                try {
                  ...
                  if (e.toString().contains('duplicate_model_name')) {
                    _snack('هذا الاسم مستخدم مسبقاً، اختر اسماً آخر',
                        error: true);
                  } else {
